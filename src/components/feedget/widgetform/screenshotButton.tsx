...
export const ScreenshotButton = ({onScreenshotTook, screenshot}: Props) => {
    ...
    return (
        <button
            type='button'
            className="p-2 bg-zinc-800 text-zinc-400 roundend-md border-transparent hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-[#FFA500]"
